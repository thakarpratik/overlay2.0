...
export default function ExportTab() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
      ...
      {/* Export current — primary */}
      <button
        onClick={() => exportCurrentAsPng({ pixelRatio: 1 })}
        style={{
          width: "100%",
          padding: "11px 0",
          borderRadius: 12,
      ...
      <button
        ...
        onMouseEnter={(e) => { if (hasMultiple) e.currentTarget.style.background = "rgba(255,255,255,0.1)"; }}
